...
Благодаря инкапсуляции мы можем скрывать и защищать данные, хранящиеся в объектах Java. Java поддерживает инкапсуляцию посредством контроля доступа. В Java есть четыре модификатора управления доступом: public , private, ,protected и default.
